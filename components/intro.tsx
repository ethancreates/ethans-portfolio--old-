...
import ethan1x1hd from "@/public/ethan1x1hd.png";
    ...
    >
        ...
        <div className="relative">
          ...
          >
            <Image
              ...
              quality="95"
              priority={true}
              className="h-29 w-30 rounded-2xl object-cover border-[0.35rem] border-white shadow-xl"
            />
          </motion.div>
      ...
      >
        ...
        <a
          ...
          href="/ethancreates-resume-feb2024.pdf"
          download
        >
          Download CV{" "}
